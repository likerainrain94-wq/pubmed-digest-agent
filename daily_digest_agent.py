...
KEYWORDS = ["intensive blood pressure", "arterial hypertension", "cardiovascular disease", "cardiometabolic", "omics"]
# ---------------------
...
def format_html_email(data):
    ...
    <p><em>Generated by Dr.Yu Xiang using Google Gemini and Github</em></p>
    </body>
    </html>
    """
    return html
